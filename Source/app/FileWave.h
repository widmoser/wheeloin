#ifndef STK_FILEWAVE_H
#define STK_FILEWAVE_H
...
class FileWave : public Generator
{
 public:
  ...
  */
  FileWave( std::string fileName, bool raw = false );
...
inline StkFloat FileWave :: tick( void )
{
  // Set the wave rate.
...
inline StkFrames& FileWave :: tick( StkFrames& frames, unsigned int channel )
{
